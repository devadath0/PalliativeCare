    ...
    <div class="container mt-4">
        <div class="row mb-4">
            <div class="col-md-8">
                ...
                <p class="text-muted">Update service provider information</p>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="index.php?module=admin&action=process_edit_service" method="POST" class="needs-validation" novalidate>
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($service['id']); ?>">
                    <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($service['user_id']); ?>">
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="company_name" class="form-label">Company Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="company_name" name="company_name" 
                                   value="<?php echo htmlspecialchars($service['company_name']); ?>" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" 
                                   value="<?php echo htmlspecialchars($service['email']); ?>" required>
                            <div class="invalid-feedback">Please enter a valid email address.</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="phone" class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" id="phone" name="phone" 
                                   value="<?php echo htmlspecialchars($service['phone'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="operating_hours" name="operating_hours" 
                                   value="<?php echo htmlspecialchars($service['operating_hours'] ?? ''); ?>" 
