...
// Set page title
$page_title = 'Chat with Dr. ' . htmlspecialchars($appointment['doctor_name']);
...
<div class="container py-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2>Chat with Dr. <?php echo htmlspecialchars($appointment['doctor_name']); ?></h2>
            <p class="text-muted">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="chat-messages p-3" id="chatMessages" style="height: 400px; overflow-y: auto;">
                        <?php if (empty($messages)): ?>
                            <div class="text-center text-muted py-5">
                                ...
                                <p>No messages yet. Start the conversation with your doctor!</p>
                            </div>
                        <?php else: ?>
                            <?php foreach ($messages as $msg): ?>
                                <?php $isPatient = $msg['sender_type'] === 'patient'; ?>
                                <div class="message-container mb-3 <?php echo $isPatient ? 'text-end' : ''; ?>">
                                    <div class="message d-inline-block p-3 rounded 
                                        <?php echo $isPatient ? 'bg-primary text-white' : 'bg-light'; ?>"
                                        style="max-width: 75%;">
                                        <?php echo nl2br(htmlspecialchars($msg['message'])); ?>
                                        <div class="message-time text-<?php echo $isPatient ? 'white' : 'muted'; ?> small mt-1">
                    ...
                    <div class="chat-input p-3 border-top">
                        <form id="chatForm" method="post" action="index.php?module=patient&action=send_message">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    chatForm.addEventListener('submit', function(e) {
        ...
        // Send AJAX request
        fetch('index.php?module=patient&action=send_message', {
            method: 'POST',
            body: formData,
            headers: {
